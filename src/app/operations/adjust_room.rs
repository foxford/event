...
pub(crate) async fn call(
    ...
    let cut_original_segments = {
        ...
        cut_original_segments = remove_break_gaps_from_segments(&segments, &cut_original_segments)?;
...
pub(crate) fn invert_segments(
    ...
    if let Some((_, last_segment_stop)) = segments.last() {
        let room_duration_nanos = room_duration.num_nanoseconds().unwrap_or(i64::MAX);
