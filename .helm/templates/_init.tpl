...
- name: check
  ...
  command: ['/bin/sh', '-c', 'while ! psql -h {{ pluck .Values.werf.env (index .Values.app.database.host .Values.global.org .Values.global.app) | first | default (index .Values.app.database.host .Values.global.org .Values.global.app)._default }} -U {{ pluck .Values.werf.env (index .Values.app.database.user .Values.global.org .Values.global.app) | first | default (index .Values.app.database.user .Values.global.org .Values.global.app)._default }} -W {{ pluck .Values.werf.env (index .Values.app.database.password .Values.global.org .Values.global.app) | first | default (index .Values.app.database.password .Values.global.org .Values.global.app)._default }} -c "\c {{ pluck .Values.werf.env (index .Values.app.database.db .Values.global.org .Values.global.app) | first | default (index .Values.app.database.db .Values.global.org .Values.global.app)._default }}"; do sleep 3; done']
{{- end }}
